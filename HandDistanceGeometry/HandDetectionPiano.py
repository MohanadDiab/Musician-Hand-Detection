...
cap = cv2.VideoCapture("piano30.mp4")
    ...
    if hands:
        ...
        if hands[0]:
            ...
            if len(hands) > 1:
                ...
                joint0_depth2 = depth1
                joint1_depth2 = depth1
                joint2_depth2 = depth1
                joint3_depth2 = thump_length1 * (0.9 - thump_ratio2) / 2 + depth1
                joint4_depth2 = thump_length1 * (0.9 - thump_ratio2) + depth1
                joint5_depth2 = depth1
                joint6_depth2 = depth1
                joint7_depth2 = index_length1 * (0.9 - index_ratio2) / 2 + depth1
                joint8_depth2 = index_length1 * (0.9 - index_ratio2) + depth1
                joint9_depth2 = depth1
                joint10_depth2 = depth1
                joint11_depth2 = middle_length1 * (0.9 - middle_ratio2) / 2 + depth1
                joint12_depth2 = middle_length1 * (0.9 - middle_ratio2) + depth1
                joint13_depth2 = depth1
                joint14_depth2 = depth1
                joint15_depth2 = ring_length1 * (0.9 - ring_ratio2) / 2 + depth1
                joint16_depth2 = ring_length1 * (0.9 - ring_ratio2) + depth1
                joint17_depth2 = depth1
                joint18_depth2 = depth1
                joint19_depth2 = pinky_length1 * (0.9 - pinky_ratio2) / 2 + depth1
                joint20_depth2 = pinky_length1 * (0.9 - pinky_ratio2) + depth1
                joint_depths2 = [
                    joint0_depth2,
                    joint1_depth2,
                    joint2_depth2,
                ...
                cv2.putText(img, f'{int(depth1)} cm', (c6, v6), font, 1, (255, 255, 255), 2, cv2.LINE_AA)
